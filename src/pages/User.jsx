          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="stat">
              <div className="stat-figure text-secondary ">
                <FaUsers className="text-3xl md:text-5xl text-emerald-300" />
              </div>
            ...
            <div className="stat">
              <div className="stat-figure text-secondary">
                <FaUserFriends className="text-3xl md:text-5xl text-emerald-300" />
              </div>
            ...
            <div className="stat">
              <div className="stat-figure text-secondary">
                <FaCodepen className="text-3xl md:text-5xl text-emerald-300" />
              </div>
            ...
            <div className="stat">
              <div className="stat-figure text-secondary">
                <FaLaptopCode className="text-3xl md:text-5xl text-emerald-300" />
              </div>
